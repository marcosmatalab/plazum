# El archivo de pendientes: las familias, enteras

> **Qué es esto y qué NO es.** Esto es el CUERPO de `docs/pendientes.md`, mudado
> aquí el 22-09-2026 sin tocar una línea: las familias de fallo con su relato, su
> cardinal y su fecha. Lo que está ABIERTO se lee en
> [`docs/pendientes.md`](../pendientes.md), que es una tabla y cabe en una
> pantalla.
>
> **Por qué se separaron.** El fichero eran 2.856 líneas y 125 cabeceras, y lo
> abierto y lo cerrado vivían mezclados: quien llegaba no podía saber qué queda
> por hacer sin leerlo entero, y lo que leía primero era una auditoría de agosto.
> Un registro de pendientes que no se puede barrer en un minuto deja de usarse
> como registro.
>
> **Y no se resumió ni se borró nada**, por la misma razón por la que los
> cuadernos de hallazgos se mudaron enteros el 08-09-2026: consolidar un relato
> fechado en un resumen sin autor tira justo lo que lo hace útil. Cada sección
> conserva su ancla, así que todo enlace que existiera sigue resolviendo.
>
> Lo vigila `TestElIndiceDePendientesYElArchivoSeApuntanEnLasDosDirecciones`.
...
La casilla de la pieza 1 (`docs/ETAPAS.md`) dice que el cliente suelta sus documentos
...
37. ~~**No hay forma barata de vigilar que los enlaces sigan vivos.**~~
    ...
    **Lo que esto retira, dicho para que conste:** la idea de una casilla de
    "canario de enlaces". En `docs/ETAPAS.md` NO habia tal casilla que retirar; la
