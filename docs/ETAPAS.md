...
**Y esto queda escrito como mérito del censo, porque para esto servía:** midiendo el corpus se encontró un **hueco del motor**. El censo (`https://github.com/marcosmatalab/plazum/blob/5110063697ba6dad9f2b818c4284fdf9232f1111/docs/censo-relojes.md`) no era contenido, era la medición que decide el orden de todo lo que queda, y lo primero que ha decidido es que el corpus no empieza todavía.
