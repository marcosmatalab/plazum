...
**La marca, antes de invertir en ella:** búsqueda de anterioridades y solicitud EUIPO (clases 9 y 42, ~850 €) en la semana 0. Aviso encontrado por la revisión: existe una fintech internacional llamada Dutiq, y "Dutiq" es término financiero común en alemán, justo el mercado del año 2. **Decisión de nombre definitivo antes del primer release público**, con alternativa preparada si la búsqueda pinta mal.
