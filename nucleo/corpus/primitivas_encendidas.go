...
type DeclaracionDePrimitiva struct {
	...
	// (https://github.com/marcosmatalab/plazum/blob/a1ef407850fba1887977cc255e7eddfd9173d962/docs/censo-relojes.md) pide esta primitiva y hoy no se pueden escribir.
