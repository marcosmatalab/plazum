...
- [ ] DECISIÓN DE MARCA, con la comprobación ya hecha. **TMview consultado el 25-08-2026 y el resultado es peor de lo que suponíamos.** Hay DOS EUTM de "Utiq" REGISTRADAS (no solicitadas), del titular Utiq SA/NV (belga, Rue aux Laines, 1000 Bruselas; representante SIRIUS LEGAL): **018838934** denominativa y **018838908** figurativa, ambas solicitadas el 21-02-2023, registradas el 13-06-2023 y vigentes hasta el 21-02-2033. Clases **9, 25, 35, 38 y 42**, o sea más amplias que las 9/35/42 que suponíamos. Y el solape no es de número de clase sino de contenido: la clase 42 cubre literalmente "Software as a service [SaaS]", "Platform as a service [PaaS]", "Development of systems for the processing of data" y "Technical advisory services relating to data processing", y la clase 9 cubre "Application software" y "Computer programmes for data processing". Eso es exactamente lo que es dutiq. La denominativa es la que pesa: protege el signo con independencia del logotipo. **Esto no es un dictamen jurídico y no lo va a ser mío**: si el riesgo de confusión entre DUTIQ y UTIQ es asumible lo dice un agente de la propiedad industrial, y conviene preguntarlo ANTES de gastar los ~850 € de la solicitud y antes de la primera release firmada, que publica el nombre en Rekor de forma irreversible
...
- [~] HITO: v0.2 firmada. **BLOQUEADO por decisión de marca, no por trabajo pendiente.** El tag v0.2.0 está creado en local y NO se empuja. Razón: el workflow de release firma con cosign keyless, que sube el certificado al log público de Rekor con la identidad del repositorio dentro, y Rekor es append-only. La primera release firmada publicaría el nombre de forma irreversible, y la comprobación de TMview del 25-08-2026 encontró dos EUTM de "Utiq" REGISTRADAS con solape textual en clases 9 y 42 (ver docs/marca.md). Mientras la marca esté congelada: no se empuja el tag, no hay release firmada, nada va a Rekor y el repositorio sigue privado. Se desbloquea con la decisión de marca, no con código. **La etapa 1 se cierra en 12 de 13 con este hito diferido**
...
- [x] serve con html/template + htmx vendorizado, go:embed, sesiones, y la orden `dutiq serve` que lo levanta. Las dos superficies se construyeron en frentes distintos y sin conocerse, que es lo que permite sustituir cualquiera de las dos; el precio es que alguien tiene que juntarlas, y ese alguien es `cmd/dutiq/serve.go`, el único sitio del producto donde las dos se nombran a la vez. **Arranca en 692 ms hasta la primera respuesta** contra un presupuesto de 3 s, con CSP, HSTS, X-Frame-Options y Referrer-Policy en la respuesta real, POST sin CSRF a 403, y las pantallas con TEXTO y no con las claves en crudo. La puerta se comprueba levantándolo y pidiéndole páginas por la red, no sobre el handler. Verificado por mutación: sustituyendo el catálogo por uno que devuelve la clave, rojo; tomando cualquier dirección por local (la cookie de sesión saldría sin la marca de segura hacia fuera), rojo; y arrancando con un corpus vacío, rojo, con mensaje en vez de con un cuelgue, que fue el tercer hallazgo
