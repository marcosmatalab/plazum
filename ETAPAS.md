...
- [ ] Búsqueda de anterioridades de marca + solicitud EUIPO (clases 9 y 42). ÁMBAR OSCURO, hay un riesgo concreto sobre la mesa: **UTIQ**, la joint venture de Deutsche Telekom, Orange, Telefónica y Vodafone, tiene marca registrada en clases 9, 35 y 42, y "DUTIQ" contiene "UTIQ" entero. Las clases 9 y 42 son exactamente las que pide este proyecto, así que el solape es de clase y de signo a la vez, y enfrente hay cuatro telecos con presupuesto de oposición. No es un descarte automático pero tampoco es vía libre: es el riesgo que decide si el nombre sobrevive. Comprobación en TMview PENDIENTE, la hace Marcos. No se cambia el nombre hasta tener ese resultado. Decidir nombre definitivo ANTES del primer release público
