...
2. Toda obligación: cita exacta al artículo, clase primaria, vigencia. Todo reloj: mínimo 3 casos dorados derivados del texto (con cita_del_esperado), no de la implementación. El `esperado` es la LISTA EXHAUSTIVA de vencimientos que da el motor con esos hechos, emparejada por `hito`, con los estados sin fecha incluidos.
