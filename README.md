...
<!-- binario:inicio -->
**Y lo que ocupa, que casi nadie publica.** El binario de Linux, con `-s -w -trimpath`, mide **11,8 MB** contra un presupuesto declarado de **25 MB**. Se construye así:
...
**Ha subido 0,4 MB desde el 03-09-2026 y se dice por qué**, porque un binario que engorda sin explicación es lo que hace que nadie se crea el resto: la release **lleva el corpus dentro**, y eso es lo que convierte una máquina recién instalada de 3 relojes en 263, sin red y sin pasos extra. El presupuesto no se ha movido para acomodarlo.
<!-- binario:fin -->
