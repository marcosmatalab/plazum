...
**El corpus**: **33 paquetes** con su estrato legal ([`paquetes/CORPUS.md`](paquetes/CORPUS.md)), de los cuales **dieciseis con relojes reales: 126 hitos y 377 casos dorados** que se ejecutan contra el motor en cada ejecución de `./comprobar.sh`. El resto son esqueletos honestos con la transcripción planificada. La medición que decide el orden de autoría (**312 obligaciones con reloj censadas en 31 marcos**, tras el barrido de disyunción del 02-09-2026) está en [`docs/censo-relojes.md`](docs/censo-relojes.md).
