...
var textoEs = map[string]string{
	...
	// Las sentadas (pieza 4): el ritmo de trabajo del ano.
	"pantalla.hoy.sentadas.titulo":              "Cuantas veces hay que sentarse",
	"pantalla.hoy.sentadas.sin_fechas":          "Todavia no hay fechas, pero el ritmo ya se sabe: %d obligacion periodica de %d marcos.|Todavia no hay fechas, pero el ritmo ya se sabe: %d obligaciones periodicas de %d marcos.",
	"pantalla.hoy.sentadas.explica":             "Lo que se repite al mismo ritmo y vence el mismo mes se despacha de una vez, aunque venga de marcos distintos. El detalle de cada fecha, con su articulo y su cita, sigue estando en el calendario.",
	"pantalla.hoy.sentadas.alcance":             "Esto agrupa solo lo PERIODICO: %d de tus %d obligaciones con reloj. Las demas no se repiten a un ritmo fijo, asi que no se sientan: siguen en el calendario una a una.",
	"pantalla.hoy.sentadas.ciclo.cuenta":        "%d obligacion de %d marcos|%d obligaciones de %d marcos",
	"pantalla.hoy.sentadas.ciclo.esperando":     "%d espera un dato tuyo: la ultima vez que lo hiciste|%d esperan un dato tuyo: la ultima vez que lo hiciste",
	"pantalla.hoy.sentadas.ciclo.juntar":        "Se pueden juntar: %d de las %d se pueden adelantar.",
	"pantalla.hoy.sentadas.ciclo.fijas":         "%d no, porque la norma da el numero exacto.|%d no, porque la norma da el numero exacto.",
	"pantalla.hoy.sentadas.ciclo.mensual":       "mensual",
	"pantalla.hoy.sentadas.ciclo.bimestral":     "bimestral",
	"pantalla.hoy.sentadas.ciclo.trimestral":    "trimestral",
	"pantalla.hoy.sentadas.ciclo.cuatrimestral": "cuatrimestral",
	"pantalla.hoy.sentadas.ciclo.semestral":     "semestral",
	"pantalla.hoy.sentadas.ciclo.anual":         "anual",
	"pantalla.hoy.sentadas.ciclo.bienal":        "bienal",
	"pantalla.hoy.sentadas.ciclo.trienal":       "trienal",
	...
	"alcance.consecuencia.activa":               "Si contestas que si, se te activan %d obligaciones con sus plazos.",
	"alcance.consecuencia.ninguna":              "Contestar que si aqui no activa ninguna obligacion nueva.",
	"alcance.consecuencia.de_marcos":            "De:",
	"alcance.consecuencia.y_mas":                "y %d mas",
	...
	"alcance.pregunta.valor.escribe":            "Escribe la respuesta",
	"alcance.pregunta.valor.responder":          "Responder",
	"alcance.pregunta.valor.sin_contestar":      "Dejar sin contestar",
	"alcance.pregunta.valor.respondida":         "Has respondido %s.",
	"alcance.pregunta.valor.formato_fecha":      "en formato aaaa-mm-dd, por ejemplo 2026-09-04",
	"alcance.pregunta.valor.no_se_entiende":     "Ha llegado una respuesta y no se entiende, asi que no se ha usado.",
	"alcance.pregunta.valor.contradictorio":     "Esta pregunta llega contestada dos veces con respuestas distintas.",
	"alcance.pregunta.valor.no_se_guarda":       "Esta respuesta viaja en la direccion y todavia no se guarda en tu cuenta.",
	"alcance.valores.no_se_entienden":           "%d respuesta llego con un dato que no se entiende|%d respuestas llegaron con un dato que no se entiende",
	"alcance.derivacion.valores_sin_guardar":    "%d respuesta con valor no se guarda en tu cuenta|%d respuestas con valor no se guardan en tu cuenta",
	...
	"alcance.documentos.titulo": "Lo que ya tienes escrito",
	"alcance.documentos.intro": "Sube tu politica o tu manual y plazum te dice, para %d obligacion " +
		"de tu corpus, que parrafo tuyo habla de ella y en que pagina esta.|Sube tu politica o tu " +
		"manual y plazum te dice, para cada una de las %d obligaciones de tu corpus, que parrafo " +
		"tuyo habla de ella y en que pagina esta.",
	"alcance.documentos.ir":             "Subir un documento y ver donde mira cada norma",
	...
	"derivacion.respondiste_valor":            "Respondiste a",
	"derivacion.valor_no_se_entiende":         "Llego un dato que no se entiende para",
	...
	"aviso.directiva.consta":    "Es una directiva: obliga la norma nacional que la transpone, y en %s ya consta.",
	"aviso.directiva.no_consta": "Es una directiva y no obliga por si misma: en %s no consta transpuesta (comprobado el %s).",
