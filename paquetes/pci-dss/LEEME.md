...
- **No cubre la revision de reglas del cortafuegos, la de la segmentacion ni la
  ...
  uno, en `RITUALES.md` seccion 3 y en [`docs/hallazgos/censo-a.md`](https://github.com/marcosmatalab/plazum/blob/5110063697ba6dad9f2b818c4284fdf9232f1111/docs/hallazgos/censo-a.md).
