...
//
// 26-08-2026, el latido: 791 escritos, con el vigilante del planificador
// (nucleo/pantalla), el adaptador del pulso opt-in (adaptadores/latido), la
// pantalla Hoy y la orden `plazum latido`. Se sube el suelo a 785.
const MinimoDeCasos = 785
